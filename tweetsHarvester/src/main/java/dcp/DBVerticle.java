...
//								log.error(String.format("Over %d conflicts in inserting, seems no more new tweets so far...\nSystem exiting.", dbConflictCount));
//								container.exit();
//							}
							if (dbInsertFailCounter > NumOfDBFailForLog) {
								log.warn(String.format("Over %d inserting conflicts so far.", NumOfDBFailForLog));
