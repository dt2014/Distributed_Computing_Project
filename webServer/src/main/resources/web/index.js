...
$(function() {
    ...
    // new Date("21 April 2015").toDateString() + " to " + new
    // Date().toDateString();
    var xmlhttp;
    ...
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            document.getElementById("bn").innerHTML = "Brisbane: "
                    + (numTweets.bn - 3);
            document.getElementById("mn").innerHTML = "Melbourne: "
                    + (numTweets.mn - 3);
            document.getElementById("sn").innerHTML = "Sydney: "
                    + (numTweets.sn - 3);
        }
    }
